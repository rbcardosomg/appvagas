      ...
      <nav class="navbar navbar-expand-md navbar-light text-black shadow-sm" style="background-color: #67a8cd; ">
        <div class="container">
          <a class="navbar-brand"  href="{{ url('/') }}">
            <strong>Banco de Oportunidades</strong> para Vagas de Estágio e Trabalho
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto">
              ...
              @else
                <li class="nav-item">
                  <a  class="nav-link" href="{{ route('admin.home') }}" ><i class="fa fa-th"></i>Meu espaço</a>
                </li>
              @endguest
            </ul>
          </div>
          ...
          <div class="row justify-content-center">
            <div class="card-group">           
              <div class="card m-2" >
                ...
                <div class="card-body">
                  <h5 class="card-title">O setor de estágios do IFMG - Campus Formiga</h5>
                  <p class="card-text">Esta seção contém informações sobre o setor de estágios, legislação e documentação para a formalização da prática de estágio.</p>
                </div>
              </div>               
              ...
              <div class="card m-2" >
                ...
                <div class="card-body">
                  <h5 class="card-title">Oportunidades de Estágio e Emprego</h5>
                  <p class="card-text">Conheça as vagas disponíveis para você, estudante e egresso que desejam uma oportunidade de estágio e trabalho.</p>
                </div>
              </div>             
              ...
              <div class="card m-2" >
                ...
                <div class="card-body ">
                  ...
                  <p class="card-text">Conheça os nossos parceiros e seja você também uma empresa conveniada com o IFMG - Campus Formiga.</p>
                </div>
              </div>
            </div> <!-- fim card-group -->
          </div> <!-- fim row -->
          ...
          <div class="row justify-content-center">
            <div class="card-group">           
              <div class="card m-2">
                ...
                <div class="card-body">
                  <h5 class="card-title">Programas de estágio, cursos e oficinas de extensão</h5>
                  <p class="card-text">Aos alunos e egressos, fiquem atentos aos programas de estágio, cursos e oficinas de extensão que estejam disponíveis.</p>
                </div>
              </div>
              <div class="card m-2">
